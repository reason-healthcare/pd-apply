...
* instantiatesCanonical = "http://example.org/PlanDefinition/NeurologicalAssessmentPlan|0.2.0"
...
* status = #draft
* intent = #proposal
* instantiatesCanonical = "http://example.org/ActivityDefinition/OrderServiceActivity|0.2.0"
* subject = Reference(Patient/Patient1)
* encounter = Reference(Encounter/Encounter1)
